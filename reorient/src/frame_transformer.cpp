...
bool Transform::transform_service_callback(reorient::TransformDtoWRequest& req,reorient::TransformDtoWResponse& resp){
    ...
    this->drone_sub_=nh_.subscribe(req.dronePoseTopic, 1, &Transform::drone_callback, this);
    this->vicon_sub_=nh_.subscribe(req.viconTopic, 1, &Transform::vicon_callback, this);
